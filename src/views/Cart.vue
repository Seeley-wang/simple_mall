<template>
  <div>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" :class="{'checked':item.checked=='1'}" @click="editNum('checked',item)">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="editNum('minu',item)">-</a>
    ...
    <modal :mdShow="delmdShow" @close="closeModal">
      <p slot="message">确认删除此商品?</p>
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn--m" @click="delProduct">确认</a>
